...
import sys
sys.path.append("/n/home05/sqin/wall")
import verl.utils.reward_score.math as verl_math_verifier
...
def get_model_path(model_name):
    model_paths = {
        ...
        # llama 8b 
        "llama-3.1-8b-gsm8k": "/n/netscratch/sham_lab/Everyone/mkwun/openrlhfwd/ckpt/gsm_8k_llama_8b_I_redo"
...
def get_dataset(dataset_name):
    if dataset_name == "aime_2024":
    ...
    elif dataset_name == "math_500_train_subset":
        ...
        ds=load_dataset("openai/gsm8k","main",split="test")#"test"
        ds=ds.rename_column("question","problem")
        ds=ds.rename_column("answer","solution")
        def get_answer(x):
            return {"answer":x["solution"].split("####")[-1].strip()}
